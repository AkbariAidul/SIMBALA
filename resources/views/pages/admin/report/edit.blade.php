                        ...
                        <div class="card-body">
                            ...
                            @method('PUT')
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('resident') is-invalid @enderror" id="resident" name="resident"
                                ...
                                <div class="form-group">
                                    ...
                                    value="{{old('description', $report->description)}}" rows="5">{{old('description', $report->description)}}
                                </textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    value="{{old('address', $report->address)}}" rows="5">{{old('address', $report->address)}}
                                </textarea>
